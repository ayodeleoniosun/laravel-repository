...
test('cannot register if lastname and email address is empty', function () {
    ...
    $this->assertEquals('The email address field is required.', $responseJson->errors->email[0]);
});
...
test('cannot register if email address or phone number exist', function () {
    ...
    $this->assertEquals('The phone number has already been taken.', $responseJson->errors->phone[0]);
    $this->assertEquals('The email address has already been taken.', $responseJson->errors->email[0]);
});
